...
const faqData = [
  {
    ...
    answer:
      'You will have access to download the full Figma project including all of the pages, components, responsive pages, and also the icons, illustrations, and images included in the screens.',
  },
  {
